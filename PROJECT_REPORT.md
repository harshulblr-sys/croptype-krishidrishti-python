...
**A full-stack AI + remote-sensing system: draw a box anywhere in northern India → per-field crop map, growth-stage-aware moisture stress, 8-day crop-water deficit, and an irrigation advisory — in ~2–5 minutes.**
